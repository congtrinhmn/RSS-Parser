    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int position) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(articles.get(position).getLink()));
                ...
                articleView.loadUrl(String.valueOf(Uri.parse(articles.get(position).getLink())));
//                articleView.loadDataWithBaseURL(String.valueOf(Uri.parse(articles.get(position).getLink())), "<style>img{display: inline; height: auto; max-width: 100%;} " +
//
