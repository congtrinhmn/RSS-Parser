...
public class MainActivity extends AppCompatActivity {
    ...
    public String urlString = "https://vnexpress.net/rss/tin-moi-nhat.rss";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.trang_chu:
                urlString="https://vnexpress.net/rss/tin-moi-nhat.rss";
                loadFeed(urlString);break;
            case R.id.thoi_su:
            ...
            case R.id.giai_tri:
                ...
                loadFeed(urlString);break;
            case R.id.the_thao:
                urlString="https://vnexpress.net/rss/the-thao.rss";
                loadFeed(urlString);break;
            case R.id.phap_luat:
                urlString="https://vnexpress.net/rss/phap-luat.rss";
                loadFeed(urlString);break;
            case R.id.giao_duc:
                urlString="https://vnexpress.net/rss/giao-duc.rss";
                loadFeed(urlString);break;
            case R.id.doi_song:
                urlString="https://vnexpress.net/rss/gia-dinh.rss";
                loadFeed(urlString);break;
            case R.id.the_gioi:
